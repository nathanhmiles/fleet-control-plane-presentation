  ...
  getTechSections(): Observable<TechItem[]> {
    return of([
      ...
      },
      {
        ...
        alt: 'Considered: NgModule-per-feature, monorepo Nx workspace',
      },
      {
        ...
        alt: 'Considered: NgRx, plain BehaviorSubject services',
      },
      {
        ...
        alt: 'Considered: socket.io, raw Observable BehaviorSubjects without toSignal',
      },
      {
        ...
        alt: 'Considered: Angular Material, PrimeNG',
      },
      {
        ...
        alt: 'Considered: Karma + Jasmine, Cypress',
      },
      {
        ...
        alt: 'Considered: Vercel/Netlify, webpack builder',
      },
    ]);
  }
